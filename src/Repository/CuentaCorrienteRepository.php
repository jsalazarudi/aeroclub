...
/**
 * @extends ServiceEntityRepository<CuentaCorriente>
 *
...
class CuentaCorrienteRepository extends ServiceEntityRepository
{
    ...
    public function save(CuentaCorriente $entity, bool $flush = false): void
    {
    ...
    public function remove(CuentaCorriente $entity, bool $flush = false): void
    {
