...
/**
 * @extends ServiceEntityRepository<ProductoVenta>
 *
...
class ProductoVentaRepository extends ServiceEntityRepository
{
    ...
    public function save(ProductoVenta $entity, bool $flush = false): void
    {
    ...
    public function remove(ProductoVenta $entity, bool $flush = false): void
    {
