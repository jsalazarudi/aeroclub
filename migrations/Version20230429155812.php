 ...
 */
final class Version20230429155812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vuelo ADD reserva_vuelo_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE vuelo DROP socio_id');
        $this->addSql('ALTER TABLE vuelo DROP piloto_id');
        $this->addSql('ALTER TABLE vuelo ADD CONSTRAINT FK_B608E37527EF27EF FOREIGN KEY (reserva_vuelo_id) REFERENCES reserva_vuelo (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B608E37527EF27EF ON vuelo (reserva_vuelo_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vuelo DROP CONSTRAINT FK_B608E37527EF27EF');
        $this->addSql('DROP INDEX UNIQ_B608E37527EF27EF');
        $this->addSql('ALTER TABLE vuelo ADD piloto_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE vuelo RENAME COLUMN reserva_vuelo_id TO socio_id');
